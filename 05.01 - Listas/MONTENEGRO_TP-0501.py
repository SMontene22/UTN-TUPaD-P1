...
lista_palabras = []
lista_palabras.append("uno")
lista_palabras.append("dos")
lista_palabras.append("tres")
...
# print(numeros)
# El programa elimina el elemento que contiene el valor maximo, en este caso, el elemento de la posicion 3 (22)  
